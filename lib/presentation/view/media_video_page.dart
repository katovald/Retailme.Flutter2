...
class MediaVideoViewState
    extends ViewState<MediaVideoView, MediaVideoViewController> {
  ...
  void initState() {
    super.initState();
    _controller = VideoPlayerController.network(widget.args.url);
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  ...
                  image: DecorationImage(
                      image: AssetImage(_url), fit: BoxFit.fitHeight)),
            ),
          ],
        ),
      ),
