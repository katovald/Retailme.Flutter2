...
class RegisterDeviceViewState
    extends ViewState<RegisterDevice, RegisterDevicePageController> {
  static const String clientId = 'Id de sucursal';

  RegisterDeviceViewState()
      : super(RegisterDevicePageController(new DataAuthRepo()));
  ...
  /// Email input field
  Widget get sucursal => ControlledWidgetBuilder<RegisterDevicePageController>(
  ...
  Widget get loginButton =>
      ControlledWidgetBuilder<RegisterDevicePageController>(
          builder: (context, controller) {
